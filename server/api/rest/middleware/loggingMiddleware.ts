 ...
 * Re-exported from shared CORS middleware for consistency
 * @deprecated Use the shared corsMiddleware from server/_core/cors.ts instead
 */
export { corsMiddleware } from "../../../_core/cors";
